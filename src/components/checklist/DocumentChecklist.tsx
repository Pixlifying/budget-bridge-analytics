...
import { ClipboardList, Plus, Pencil, Trash2, Search, MessageCircle, Save, X } from 'lucide-react';
      ...
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            <ClipboardList size={20} /> Documents Required Checklist
          </DialogTitle>
        </DialogHeader>
        ...
        <div className="space-y-4">
          ...
          {selected && (
            <div className="rounded-lg border border-border bg-muted/30 p-4">
              ...
              <pre className="text-sm whitespace-pre-wrap font-sans text-foreground">{selected.documents}</pre>
            ...
            {!showForm ? (
              ...
              <div className="space-y-3 p-3 rounded-lg border border-border bg-card">
                <div className="flex items-center justify-between">
                  <h4 className="font-medium text-sm">{editingId ? 'Edit Service' : 'Add Service'}</h4>
          ...
          {filtered.length > 0 && (
            <div className="border-t border-border pt-4">
              <p className="text-xs font-medium text-muted-foreground mb-2">All Services ({filtered.length})</p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 max-h-60 overflow-y-auto">
                {filtered.map(s => (
                  ...
                  >
                    ...
                    <div className="flex gap-1 shrink-0">
                      <button onClick={(e) => { e.stopPropagation(); handleEdit(s); }} className="p-1 hover:bg-muted rounded">
                        <Pencil size={12} />
                      </button>
                      <button onClick={(e) => { e.stopPropagation(); handleDelete(s.id); }} className="p-1 hover:bg-muted rounded">
