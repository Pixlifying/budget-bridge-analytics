...
import { CalendarIcon, Receipt, Trash2 } from 'lucide-react';
    ...
    >
      <div className="container mx-auto py-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <Card className="col-span-1 md:col-span-3 lg:col-span-1 bg-blue-50">
            <CardHeader>
            ...
            <CardContent>
              <div className="space-y-4">
                <div>
                  <p className="text-sm text-muted-foreground">Total Fee Expenses</p>
