            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              {printMode === 'range' ? (
                <>
                  ...
                  <div className="flex items-center gap-2">
                    <Label className="text-sm whitespace-nowrap">End:</Label>
              ...
              <Button size="sm" variant="outline" onClick={handleDownload} className="gap-2"><Download className="h-4 w-4" />Download Excel</Button>
            </div>
          </CardContent>
        </Card>
